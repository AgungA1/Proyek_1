            ...
            <div class="w-8/12">
                ...
                <div id="dropdownAction"
                    ...
                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">
                        ...
                        <li>
                            <a href="#"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Estimator</a>
                        </li>
                        <li>
                            <a href="#"
                            ...
                            <div class="flex items-center p-5">
                                <div class="mr-4">
                                    <label for="file_input" class="cursor-pointer">
                                        <div class="relative w-20 h-20 rounded-full overflow-hidden">
                                            <img id="profile-preview" src="{{ asset('img/default-profile.png') }}"
                                                alt="Foto Profil" class="w-full h-full object-cover">
                                        </div>
                                    </label>
                                    <input class="hidden" id="file_input" name="avatar" type="file"
                                ...
                                <div class="mx-3 top-3">
                                    ...
                                    <input
                                        ...
                                        aria-describedby="file_input_help" type="file" readonly
                                        placeholder="Pilih file" onclick="document.getElementById('file_input').click()">
                ...
                <tbody>
                    <tr
                        ...
                        <th scope="row"
                            ...
                            <img class="w-10 h-10 rounded-full" src="{{ asset('img/default-profile.png') }}"
                                alt="Jese image">
                            <div class="pl-3">
                                            ...
                                            <div class="flex items-center p-5">
                                                ...
                                                <div class="mx-3 top-3">
                                                    <label
                                                        ...
                                                        for="file_input">Upload Avatar</label>
                                                    <input
                                                        class="block w-100 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                                        aria-describedby="file_input_help" type="file" readonly
