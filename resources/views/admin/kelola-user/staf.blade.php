            ...
            <div id="defaultModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                    ...
                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <!-- Modal body -->
                        <form action="{{ route('admin.staf.create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                <div>
                                    <label for="id_gudang" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Id Gudang</label>
                                    <select id="id_gudang" name="id_gudang" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                        <option selected="">Select Gudang</option>
                ...
                <tbody id="tableBody">
                    @foreach ($stafs as $staf)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4 item-center text-center">
                                {{ $staf->gudang->nama_gudang }}
                            </td>
                            <th scope="row" class="flex px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex justify-content-center">
                                    <img class="w-10 h-10 rounded-full" src="{{asset('storage/'.$staf->avatar)}}"
                                        alt="Jese image">
                                    <div class="pl-3">
                                        <div class="text-base font-semibold"> {{ $staf->nama }} </div>
                                        <div class="font-normal text-gray-500"> {{ $staf->email }} </div>
                                    </div>
                                </div>
                            </th>
                            <td class="px-6 py-4 item-center text-center">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-around ">
                                    <div>
                                        <!-- Modal toggle -->
                                        <button id="updateUserButton-{{ $staf->id }}" data-modal-toggle="updateUserModal-{{ $staf->id }}"
                                    ...
                                    <!-- Main modal -->
                                    <div id="updateUserModal-{{ $staf->id }}" tabindex="-1" aria-hidden="true"
                                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
                                        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                            <!-- Modal content -->
                                            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-modal-toggle="updateUserModal-{{ $staf->id }}">
                                                    ...
                                                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                        <div>
                                                            ...
                                                            <select id="id_gudang" name="id_gudang" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                                                <option selected="">Select Gudang</option>
                                                                @foreach($gudangs as $gudang)
                                                                <option value="{{$gudang->id}}" {{ $gudang->id == $staf->id_gudang ? 'selected' : '' }}>{{$gudang->nama_gudang}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div>
                                                            ...
                                                            <input type="text" name="nama" id="nama"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                placeholder="Name" required="" value="{{ $staf->nama }}">
                                                        </div>
                                                        <div>
                                                            <label for="username"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
                                                            <input type="text" name="username" id="username"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                placeholder="Username" required="" value="{{ $staf->username }}">
                                                        </div>
                                                        <div>
                                                            <label for="email"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                                                            <input type="text" name="email" id="email"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                placeholder="name@xxx.com" required="" value="{{ $staf->email }}">
                                                        </div>
                                                        <div>
                                                            <label for="password"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="text" name="no_telp" id="no_telp"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                placeholder="08xxxxxxxxxx" required="" value="{{ $staf->no_telp }}">
                                                        </div>
                                                    </div>
                                                    <div class="flex items-center p-5">
                                                        <div class="mr-4">
                                                            <label for="file_input" class="cursor-pointer">
                                                                <div class="relative w-20 h-20 rounded-full overflow-hidden">
                                                                    <img id="profile-preview" src="{{asset('storage/'.$staf->avatar)}}" alt="Foto Profil" class="w-full h-full object-cover">
                                                                </div>
                                                            </label>
                                                        </div>
                                                        <div class="mx-3 top-3">
                                    ...
                                    <div>
                                        <button type="button" id="deleteUserButton-{{ $staf->id }}" data-modal-target="deleteUserModal" data-modal-toggle="deleteUserModal-{{ $staf->id }}"
                                    ...
                                    <div id="deleteUserModal-{{ $staf->id }}" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                        <div class="relative w-full max-w-md max-h-full">
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                <button type="button" class="close-modal absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="deleteUserModal-{{ $staf->id }}">
                                                    <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                                    <span class="sr-only">Close modal</span>
                                                </button>
                                                <div class="p-6 text-center">
                                                    ...
                                                    <div class="flex justify-center">
                                                        <form action="{{ route('admin.delete', $staf->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button data-modal-toggle="deleteUserModal-{{ $staf->id }}" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                                Yes, I'm sure
                                                            </button>
                                                        </form>
                                                        <button data-modal-toggle="deleteUserModal-{{ $staf->id }}" type="button" class="close-modal text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No, cancel</button>
