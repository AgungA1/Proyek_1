...
<div class="flex flex-col relative">
    ...
    <h2 class="mb-2 text-l font-medium leading-none tracking-tight text-gray-900 md:text-xl dark:text-white">List of Re-stock Suggestion</h2>
    <hr class="h-0.5 my-2 bg-black border-0 dark:bg-gray-700">

    <form class=" w-5/12 mt-6 mb-8 self-end" action="{{ route('admin.note') }}" method="get" role="search">   
        @csrf
        @method('GET')
        ...
        <table class="w-full mt-4 text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <form class="py-4" id="form-{{$request->id}}" action="{{ route('estimator.request.destroy', $request->id) }}" method="post">
                        @csrf
                        @method('DELETE')
                        <td class="px-3 py-4">
                                ...
                                <div class="relative w-full max-w-md max-h-full">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-6 text-center">
                                            ...
                                            <button form="form-{{$request->id}}" data-modal-hide="delete-{{$request->id}}" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                Yes, I'm sure
                                            </button>
