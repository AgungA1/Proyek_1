 ...
 <aside id="logo-sidebar"
     ...
     <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
         <ul class="space-y-2 font-medium">
             ...
             <li>
                 <a href="{{ route('staf.response.index') }}"
                     class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                     <svg aria-hidden="true"
                         class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                         fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
             ...
             <li>
                 <a href="{{route('staf.upcoming')}}"
                     ...
                     <span class="flex-1 ml-3 whitespace-nowrap">Upcoming Item Transfers</span>
                 </a>
             </li>
             <li>
                 <button type="button"
                 ...
                 <ul id="dropdown-example" class="hidden py-2 space-y-2">
                     <li>
                         <a href="{{route('staf.reportBarangMasuk')}}"
                     ...
                     <li>
                         <a href="{{ route('staf.reportBarangKeluar') }}"
                             class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Barang
                             Keluar</a>
                     </li>
                 </ul>
